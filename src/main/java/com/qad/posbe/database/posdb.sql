...
CREATE TABLE `products` (
  ...
  `quantity` int NOT NULL,
  `status` enum('IN_STOCK','OUT_OF_STOCK','INACTIVE') DEFAULT 'IN_STOCK',
  `updated_at` datetime(6) DEFAULT NULL,
  `updated_by` varchar(255) DEFAULT NULL,
